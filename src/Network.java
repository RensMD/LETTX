...
public class Network {
	...
	private int numTempBytes = 0, numTotBytes = 0;
	 ...
	 *            {@link Network_iface#parseInput(int, int, int[])} once the
	 *            following {@link #divider} could be identified.
	 */
	Network(int id, Network_iface contact, int divider) {
	 ...
	 * using {@link Network#divider} into arrays of <b>int</b>s and
